...
#undef FD_ISSET
#undef FD_ZERO
#define FD_SETSIZE		should_use_LINUX_xxxx
#define FD_SET			should_use_LINUX_xxxx
#define FD_CLR			should_use_LINUX_xxxx
#define FD_ISSET		should_use_LINUX_xxxx
#define FD_ZERO			should_use_LINUX_xxxx
